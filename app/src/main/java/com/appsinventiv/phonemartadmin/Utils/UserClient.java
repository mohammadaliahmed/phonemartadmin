package com.appsinventiv.phonemartadmin.Utils;
...
public interface UserClient {
    ...
    @Headers("Content-Type: application/json")
    @POST("api/admin/getRecentAds")
    Call<ApiResponse> getRecentAds(
            @Body JsonObject jsonObject
    ...
    @Headers("Content-Type: application/json")
    @POST("api/admin/approveAd")
    Call<ApiResponse> approveAd(
            @Body JsonObject jsonObject

    );

    @Headers("Content-Type: application/json")
    @POST("api/admin/pendingAd")
    Call<ApiResponse> pendingAd(
            @Body JsonObject jsonObject
